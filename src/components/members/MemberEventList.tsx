          ...
          <div className="flex w-full items-center justify-between space-x-6 p-6">
            <div className="flex-1 truncate">
              <div className="flex items-center space-x-3">
                ...
                <span className="inline-flex flex-shrink-0 items-center rounded-full bg-role-member/10 px-1.5 py-0.5 text-xs font-medium text-role-member ring-1 ring-inset ring-role-member/30">
                  {person.role}
                </span>
              </div>
          ...
          <div>
            <div className="-mt-px flex divide-x divide-gray-200">
              <div className="flex w-0 flex-1">
                <Button className="bg-destructive text-destructive-foreground hover:bg-destructive/90 my-5">
                  Cancel
                </Button>
              </div>
